...
public class FormaDePagamentoCredito implements FormaDePagamentoCalculavel{

    @Override
    public BigDecimal calcularFormaPGTO(Compra compra, BigDecimal valorTotalCompra) {
        return  valorTotalCompra.subtract(valorTotalCompra.multiply(new BigDecimal(0.05)));
    }
}
